...
一个能够感知环境、做出决策并采取行动以实现特定目标的自主程序。在 AmritaCore 中，智能Agent可以与用户交互、调用工具并管理复杂任务。
...
### 8.3.3 许可证信息 (AGPL-3.0)

AmritaCore 根据 GNU Affero 通用公共许可证第 3.0 版发布。
