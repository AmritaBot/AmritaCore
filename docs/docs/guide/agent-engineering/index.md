...
Making agents _behave well_ is an engineering discipline. This section covers
the practical craft: prompts, templates, and — most importantly — what to do
...
> understand the runtime ([Concepts](../concepts/index.md)).
